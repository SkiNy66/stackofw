...
RSpec.describe SubscriptionsController, type: :controller do
    ...
    context 'authenticated user' do
      ...
      context 'not subscribed' do
        ...
        it 'change user and question subscriptions count' do
          expect { subscription_create }.to change(user2.subscriptions, :count).by(1) && change(question.subscriptions, :count).by(1)
        end
      ...
      context 'already subscribed' do
        ...
        it 'change user and question subscriptions count' do
          expect { subscription_create }.to_not change(user2.subscriptions, :count) && change(question.subscriptions, :count)
        end
      end
    end
  ...
  describe 'DELETE #destroy' do
    ...
    context 'subscribed authenticated user' do
      ...
      it 'change user and question subscriptions count' do
        expect { subscription_destroy }.to change(user2.subscriptions, :count).by(-1) && change(question.subscriptions, :count).by(-1)
      end
    end
    ...
    context 'not subscribed authenticated user' do
      ...
      it 'change user and question subscriptions count' do
        expect { subscription_destroy }.to_not change(user2.subscriptions, :count) && change(question.subscriptions, :count)
      end
    end
